...
# Copyright (C) 2019 magrco <im@magrco.com>
# URL: https://www.magrco.com/archives/kms.html
#
...
install_main() {
    ...
    echo
    echo " URL: https://www.magrco.com/archives/kms.html"
    echo "----------------------------------------"
    echo
    ...
    echo "Welcome to visit:https://www.magrco.com/archives/kms.html"
    echo "Enjoy it!"
    echo
}
